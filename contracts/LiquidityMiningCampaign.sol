...
contract LiquidityMiningCampaign is StakeTransferer, OnlyExitFeature {
  ...
  {
    require(
      _albtAddress == _rewardsTokens[0],
      'constructor:: The first reward address is different from the ALBT'
    );
  ...
  function setReceiverWhitelisted(address receiver, bool whitelisted)
    public
    override(StakeTransferer)
    onlyFactory
  {
